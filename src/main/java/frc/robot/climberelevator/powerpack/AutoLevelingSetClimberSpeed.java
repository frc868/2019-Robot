...
public class AutoLevelingSetClimberSpeed extends PIDCommandPlus {
    private double targetSpeed;
    private static final double P = 1.0, I = 0.0, D = 0.0;

    public AutoLevelingSetClimberSpeed(double targetSpeed) {
        this(targetSpeed, P, I, D);
    }

    public AutoLevelingSetClimberSpeed(double targetSpeed, double kP, double kI, double kD) {
        super(kP, kI, kD, 0);
