...
public class LHab2ToFrontRocket extends CommandGroup { //TODO: finished condition in followvision
  /**
   ...
   */
  public LHab2ToFrontRocket(int position) {
    addSequential(new DriveStraightNoPID(48,0.3,0.3));
